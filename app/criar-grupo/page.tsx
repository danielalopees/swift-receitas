        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div>
            <Card className="border-red-100 shadow-md">
              <Card.Header className="bg-gradient-to-r from-red-500 to-amber-500 text-white rounded-t-lg">
                <Card.Title className="text-xl">Informações do Grupo</Card.Title>
              </Card.Header>
              <Card.Body className="pt-6">
                <div className="space-y-4">
                  <div>
                    <Form.Label htmlFor="nome-grupo" className="block text-sm font-medium text-gray-700 mb-1">
                      Nome do Grupo
                    </Form.Label>
                    <Form.Control
                      id="nome-grupo"
                  ...
                  <div>
                    <Form.Label htmlFor="data" className="block text-sm font-medium text-gray-700 mb-1">
                      Data do Churras
                    </Form.Label>
                    <Form.Control id="data" type="date" className="border-red-200 focus:border-red-500 focus:ring-red-500" />
                  </div>

                  <div>
                    <Form.Label htmlFor="local" className="block text-sm font-medium text-gray-700 mb-1">
                      Local
                    </Form.Label>
                    <Form.Control
                      id="local"
          ...
          <div>
            <Card className="border-red-100 shadow-md">
              <Card.Header className="bg-gradient-to-r from-amber-500 to-amber-600 text-white rounded-t-lg">
                <Card.Title className="text-xl flex items-center justify-between">
                  <span>Adicionar Amigos</span>
                  <Badge bg="light" text="dark">{amigos.length} amigos</Badge>
                </Card.Title>
              </Card.Header>
              <Card.Body className="pt-6">
                <div className="space-y-4">
                      ...
                      {amigos.map((amigo) => (
                        ...
                        >
                          <div className="flex items-center">
                            <Image src={amigo.avatar || "/placeholder.svg"} roundedCircle className="h-10 w-10 mr-3" />
                            <div>
                              <p className="font-medium text-gray-800">{amigo.nome}</p>
                              <p className="text-xs text-gray-500">{amigo.cpf}</p>
                            </div>
                          </div>
                          <Button variant="link" size="sm" className="text-gray-400 hover:text-red-500">
                            <X className="h-4 w-4" />
                          </Button>
                        </div>
                      ))}
                  ...
                  <div className="pt-4">
                    <Link href="/escolher-produtos" passHref>
                      <Button variant="warning" className="w-full text-white">
