        ...
        <div className="max-w-md mx-auto">
          <Card className="border-red-100 shadow-md">
            <Card.Header className="bg-gradient-to-r from-red-500 to-amber-500 text-white rounded-t-lg">
              <Card.Title className="text-xl">Encontre seu Grupo</Card.Title>
            </Card.Header>
            <Card.Body className="pt-6">
              <div className="space-y-4">
                <div>
                  <Form.Label htmlFor="codigo-grupo" className="block text-sm font-medium text-gray-700 mb-1">
                    Código do Grupo
                  </Form.Label>
                ...
                <div className="pt-4">
                  <Button variant="danger" className="w-full">Buscar Grupo</Button>
                </div>
                ...
                <div>
                  <Form.Label htmlFor="cpf" className="block text-sm font-medium text-gray-700 mb-1">
                    Seu CPF
                  </Form.Label>
                  <Form.Control
                    id="cpf"
                ...
                <div className="pt-4">
                  <Button variant="warning" className="w-full text-white">Encontrar meus Grupos</Button>
                </div>
              </div>
            </Card.Body>
          </Card>
